...
python 04_1_filter_testmols.py --input ${data_path}/04_split_mols_chembl_with_pka_v${version}.sdf.gz  --output ${data_path}/04_split_mols_v${version}.sdf --filter ${data_path}/00_AvLiLuMoVe_testdata.sdf,${data_path}/00_novartis_testdata.sdf
