...
#python 06_training.py --input ${data_path}/05_chembl_pretrain_data_v0_pyg_data.pkl --model ${data_path}/trained_models_v0/training_with_${model_name}_v${version}_${parameter_size} --model_name ${model_name} --epoch 1000
